                ...
                {request ? (
                  <div className="mt-4">
                    ...
                    {request.status === 'approved' && (
                      <div className="mt-4">
                        <Button type="button" onClick={() => window.location.href = '/dashboard/ib'}>Open IB Dashboard</Button>
                      </div>
                    )}
                  </div>
                ) : (
